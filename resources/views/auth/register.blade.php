        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-1">
                                Regístrate para agendar consultas y acceder a tu historial clínico
                            </p>
                            <p class="text-muted small mb-0">
                                ¿Ya tienes cuenta? 
                                @if (Route::has('login'))
                                    <a href="{{ route('login') }}" class="text-decoration-none fw-semibold" style="color: var(--brand-primary-400);">
                                        Inicia sesión aquí
                                    </a>
                                @endif
                            </p>
                        ...
                        <form method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            {{-- Nombre completo --}}
                            <div class="mb-3">
                                <label for="name" class="form-label fw-semibold text-secondary label">
                                    {{ __('Nombre completo') }}
                                </label>
                                <div class="position-relative">
                                    ...
                                    <input 
                                        id="name" 
                                        type="text" 
                                        class="form-control input ps-5 @error('name') is-invalid @enderror" 
                                        name="name" 
                                        value="{{ old('name') }}" 
                                        required 
                                        autocomplete="name" 
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <button 
                                        ...
                                        onclick="togglePasswordField('password', 'eyeIconPassword')"
                                    >
                                        <svg id="eyeIconPassword" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="mb-4">
                                <label for="password-confirm" class="form-label fw-semibold text-secondary label">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input 
                                        id="password-confirm" 
                                        type="password" 
                                        class="form-control input ps-5 pe-5" 
                                    ...
                                    <button 
                                        ...
                                        class="btn btn-link position-absolute text-muted p-0" 
                                        style="right: 12px; top: 50%; transform: translateY(-50%); text-decoration: none;"
                                        onclick="togglePasswordField('password-confirm', 'eyeIconConfirm')"
                                    >
                        ...
                        <div class="text-center mt-4 pt-4 border-top">
                            <p class="text-muted mb-0 small">
                                ...
                                @if (Route::has('login'))
                                    <a href="{{ route('login') }}" class="text-decoration-none fw-semibold" style="color: #007bff;">
                                        Iniciar sesión
                                    </a>
                                @endif
                            </p>
                ...
                <div class="text-center mt-4">
                    <p class="text-muted small mb-1">Al registrarte, aceptas nuestros</p>
...
<style>
    ...
    .btn-outline-secondary svg { opacity: 1; }
...
@push('scripts')
<script>
    // Expose function to window to ensure onclick handlers can call it
