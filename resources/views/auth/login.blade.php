        ...
        <div class="col-md-8">
            <div class="form-panel">
                <div class="form-header">
                    ...
                    <div class="subtitle">Accede para ver horarios y agendar tus citas</div>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group row mb-3">
                        <label for="email" class="col-md-4 col-form-label text-md-end label">{{ __('Email Address') }}</label>
                    ...
                    <div class="form-group row mb-3">
                        <label for="password" class="col-md-4 col-form-label text-md-end label">{{ __('Password') }}</label>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-8 offset-md-4" style="display:flex; gap:0.5rem; align-items:center;">
